(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'), require('babel-runtime/helpers/typeof'), require('babel-runtime/core-js/promise'), require('babel-runtime/regenerator'), require('babel-runtime/helpers/asyncToGenerator'), require('babel-runtime/core-js/object/assign'), require('n-zepto'), require('xpath-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/createClass', 'babel-runtime/helpers/typeof', 'babel-runtime/core-js/promise', 'babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'babel-runtime/core-js/object/assign', 'n-zepto', 'xpath-dom'], factory) :
  (factory((global.VueEpg = {}),global._classCallCheck,global._createClass,global._typeof,global._Promise,global._regeneratorRuntime,global._asyncToGenerator,global._Object$assign,global.$,global.xpathDom));
}(this, (function (exports,_classCallCheck,_createClass,_typeof,_Promise,_regeneratorRuntime,_asyncToGenerator,_Object$assign,$,xpathDom) { 'use strict';
  ...
  var EpgService = function () {
    ...
    _createClass(EpgService, [{
      ...
      value: function getPointerPosition() {
        var path = xpathDom.getXPath(this.pointer.$el);
        return { xpath: path };
      }
    }, {
      key: "enter",
